  ...
  <div class="min-h-screen flex items-center justify-center px-4 py-8">
    <div class="max-w-md w-full bg-white rounded-2xl shadow-sm p-8">
      <div class="flex flex-col items-center mb-6">
        <LogoElanga :size="48" />
        <h1 class="text-xl font-semibold text-gray-800 mt-3">Creer un compte administrateur</h1>
        <p class="text-xs text-gray-500 text-center mt-1">
          Un code d'invitation est requis, fourni par l'equipe technique ELANGA.
        </p>
      </div>
      ...
      <form @submit.prevent="soumettre" class="space-y-4">
        ...
        <div>
          <label class="text-sm text-gray-600">Code d'invitation</label>
        ...
        <button type="submit" :disabled="chargement"
          ...
          {{ chargement ? 'Creation en cours...' : 'Creer le compte' }}
        </button>
      </form>
