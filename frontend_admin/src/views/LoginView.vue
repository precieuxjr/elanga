  ...
  <div class="min-h-screen flex items-center justify-center px-4">
    <div class="max-w-sm w-full bg-white rounded-2xl shadow-sm p-8">
      <div class="flex flex-col items-center mb-6">
        <LogoElanga :size="48" />
        <h1 class="text-xl font-semibold text-gray-800 mt-3">Espace administrateur</h1>
        <p class="text-xs text-gray-500 text-center mt-1">ELANGA — gestion des signalements et des citoyens</p>
      </div>
      ...
      <p class="text-sm text-gray-500 text-center mt-5">
        ...
        <router-link :to="{ name: 'inscription' }" class="text-primary-600 font-medium">Creer un compte administrateur</router-link>
      </p>
    </div>
  </div>
</template>
